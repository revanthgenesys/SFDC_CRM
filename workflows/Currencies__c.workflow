...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>Genesys_Customer_Care_Templates/Currency_Approval_Email_Template</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Genesys_Customer_Care_Templates/Currency_Rejection_Email_Template</template>
    </alerts>
    <fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Freeze_Currency_Record</fullName>
        <field>Currency_Freeze__c</field>
        <literalValue>1</literalValue>
        <name>Freeze Currency Record</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
